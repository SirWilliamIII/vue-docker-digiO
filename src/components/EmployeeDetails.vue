<template>
  <div class="details container">
    ...
    <h1 class="page-header">{{employee.first_name}} {{employee.last_name}}
    ...
    <ul class="list-group">
            <li class="list-group-item"><span class="glyphicon glyphicon-phone" aria-hidden="true"></span> {{employee.phone}}</li>
            <li class="list-group-item"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> {{employee.email}}</li>
        </ul>
